        ...
        >
          ...
          >
            ...
            <motion.button
              ...
              className="hidden sm:block absolute left-6 top-1/2 -translate-y-1/2 text-white w-12 h-12 rounded-full items-center justify-center transition-all opacity-0 group-hover:opacity-100"
              style={{
            ...
            <motion.button
              ...
              className="hidden sm:block absolute right-6 top-1/2 -translate-y-1/2 text-white w-12 h-12 rounded-full items-center justify-center transition-all opacity-0 group-hover:opacity-100"
              style={{
                background: `linear-gradient(135deg, ${colors.dark} 0%, rgba(31, 96, 96, 0.8) 100%)`,
                ...glassStyle
              }}
