...
// Professional organized club data
const clubCategories = [
  {
    id: 'sports',
    name: 'Sports',
    clubs: [
      { id: '1', icon: 'futsal', title: 'Futsal Club', description: 'Master your footwork and teamwork on the field' },
      { id: '2', icon: 'voli', title: 'Volleyball Club', description: 'Spike your way to victory with our team' },
      { id: '3', icon: 'basket', title: 'Basketball Club', description: 'Dribble, shoot, and score like a pro' },
      { id: '8', icon: 'silat', title: 'Pencak Silat', description: 'Traditional martial arts mastery' },
      { id: '9', icon: 'kempo', title: 'Kempo Club', description: 'Japanese martial arts training' },
      { id: '10', icon: 'karate', title: 'Karate Club', description: 'Discipline through martial arts' },
      { id: '15', icon: 'anggar', title: 'Fencing Club', description: 'Train your precision and strategy' }
    ]
  },
  {
    id: 'arts',
    name: 'Arts',
    clubs: [
      { id: '5', icon: 'tari', title: 'Dance Art', description: 'Express yourself through graceful movements' },
      { id: '13', icon: 'music', title: 'Music Club', description: 'Create harmony with fellow musicians' },
      { id: '12', icon: 'jurnalistik', title: 'Journalism Club', description: 'Uncover and report school news' }
    ]
  },
  {
    id: 'academics',
    name: 'Academics',
    clubs: [
      { id: '11', icon: 'kir', title: 'Science Club', description: 'Explore the wonders of science' },
      { id: '16', icon: 'aflateen', title: 'English Club', description: 'Improve your language skills' },
      { id: '7', icon: 'rohis', title: 'Religious Study', description: 'Deepen your spiritual knowledge' }
    ]
  },
  {
    id: 'other',
    name: 'Others',
    clubs: [
      { id: '4', icon: 'pramuka', title: 'Scout Club', description: 'Learn survival skills and outdoor adventures' },
      { id: '6', icon: 'paskibra', title: 'Flag Corps', description: 'Discipline and patriotism in every march' },
      { id: '14', icon: 'pmr', title: 'First Aid Club', description: 'Learn life-saving medical skills' }
    ]
  }
];
...
const Clubs = () => {
  // Flatten all clubs for the original layout
  const allClubs = clubCategories.flatMap(category => category.clubs);
  ...
  return (
    ...
    >
      <div className="container lg:flex flex-col lg:flex-row gap-12 items-center">
        ...
        {/* Right Content - Feature Visualization (Original) */}
